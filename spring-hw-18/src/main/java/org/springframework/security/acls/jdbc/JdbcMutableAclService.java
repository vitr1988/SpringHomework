...
public class JdbcMutableAclService extends JdbcAclService implements MutableAclService {
    private static final String DEFAULT_INSERT_INTO_ACL_CLASS = "insert into acl_class (class) values (?)".toUpperCase();
    private static final String DEFAULT_INSERT_INTO_ACL_CLASS_WITH_ID = "insert into acl_class (class, class_id_type) values (?, ?)".toUpperCase();
    // ~ Instance fields
    // ================================================================================================

    private boolean foreignKeysInDatabase = true;
    private final AclCache aclCache;
    private String deleteEntryByObjectIdentityForeignKey = "delete from acl_entry where acl_object_identity=?".toUpperCase();
    private String deleteObjectIdentityByPrimaryKey = "delete from acl_object_identity where id=?".toUpperCase();
    ...
    private String insertObjectIdentity = ("insert into acl_object_identity "
            ...
            + "values (?, ?, ?, ?)").toUpperCase();
    private String insertSid = "insert into acl_sid (principal, sid) values (?, ?)".toUpperCase();
    private String selectClassPrimaryKey = "select id from acl_class where class=?".toUpperCase();
    private String selectObjectIdentityPrimaryKey = ("select acl_object_identity.id from acl_object_identity, acl_class "
            ...
            + "and acl_object_identity.object_id_identity = ?").toUpperCase();
    private String selectSidPrimaryKey = "select id from acl_sid where principal=? and sid=?".toUpperCase();
