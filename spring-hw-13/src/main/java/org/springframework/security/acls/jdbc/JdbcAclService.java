...
public class JdbcAclService implements AclService {
    ...
    private static final String DEFAULT_SELECT_ACL_CLASS_COLUMNS = "class.class as class".toUpperCase();
    private static final String DEFAULT_SELECT_ACL_CLASS_COLUMNS_WITH_ID_TYPE = (DEFAULT_SELECT_ACL_CLASS_COLUMNS + ", class.class_id_type as class_id_type").toUpperCase();
    private static final String DEFAULT_SELECT_ACL_WITH_PARENT_SQL = ("select obj.object_id_identity as obj_id, " + DEFAULT_SELECT_ACL_CLASS_COLUMNS
            ...
            + "select id FROM acl_class where acl_class.class = ?)").toUpperCase();
