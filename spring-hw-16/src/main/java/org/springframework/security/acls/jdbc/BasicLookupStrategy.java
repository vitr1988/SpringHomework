...
public class BasicLookupStrategy implements LookupStrategy {
    ...
    private final static String DEFAULT_SELECT_CLAUSE_COLUMNS = ("select acl_object_identity.object_id_identity, "
            ...
            + "acl_class.class ").toUpperCase();
    private final static String DEFAULT_SELECT_CLAUSE_ACL_CLASS_ID_TYPE_COLUMN = ", acl_class.class_id_type  ".toUpperCase();
    private final static String DEFAULT_SELECT_CLAUSE_FROM = ("from acl_object_identity "
            ...
            + "left join acl_sid on acl_entry.sid = acl_sid.id  " + "where ( ").toUpperCase();
    ...
    private final static String DEFAULT_LOOKUP_KEYS_WHERE_CLAUSE = "(acl_object_identity.id = ?)".toUpperCase();

    private final static String DEFAULT_LOOKUP_IDENTITIES_WHERE_CLAUSE = "(acl_object_identity.object_id_identity = ? and acl_class.class = ?)".toUpperCase();

    public final static String DEFAULT_ORDER_BY_CLAUSE = (") order by acl_object_identity.object_id_identity"
            + " asc, acl_entry.ace_order asc").toUpperCase();
